                    ...
                    <div className="row py-2 py-md-3">
                        <div className="col-12">
                            <div className="footer-content d-flex flex-column flex-md-row align-items-center justify-content-center gap-2 gap-md-3">
                                <button onClick={() => setShowTerms(true)} className="footer-link btn btn-link p-0">Terms of Service</button>
                                <span className="footer-separator d-none d-md-inline">•</span>
                                <button onClick={() => setShowKVKK(true)} className="footer-link btn btn-link p-0">KVKK</button>
                                <span className="footer-separator d-none d-md-inline">•</span>
                                <span className="footer-copyright">2026 Planora. All rights reserved.</span>
                            </div>
                        </div>
                    </div>
                </div>
